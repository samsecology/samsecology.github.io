  ...
  /**
   * Bird Animation Skeleton
   * Replace this section with your actual bird flocking code.
   * This skeleton sets up a canvas and a main animation loop.
   */
var Bird = {
  def: function(n, m, s) {
...
window.addEventListener('resize',function(){
  ...
  // Bird array
  var birds = []; // Fill this array with your bird objects

  // Example Bird object structure
  function Bird() {
  ...
  Bird.prototype.update = function() {
    // Add flocking/math logic here
    this.x += Math.cos(this.angle) * this.speed;
    this.y += Math.sin(this.angle) * this.speed;

    // Wrap around screen
    if (this.x < 0) this.x += c.width;
    if (this.x > c.width) this.x -= c.width;
