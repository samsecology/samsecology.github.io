document.addEventListener('DOMContentLoaded', function() {
  // --- 1. Anchor smooth scroll: FIRST thing in your DOMContentLoaded handler ---
  document.querySelectorAll('a[href^="#"]').forEach(anchor => {
    anchor.addEventListener('click', function(e) {
      e.preventDefault(); // Prevent default browser jump IMMEDIATELY
  ...
  // --- 2. Clear hash and scroll to top if hash present (optional, keep as needed) ---
